List projects = [
  {
    ...
    "description": "his is a script I created to challenge myself using Python. I’ve been using this language a lot in my current job and been fascinated with the huge number of things I can create with it. This project is essentially a script that monitors a specific folder on my laptop for any changes, when a file is placed into this folder the script will check the file type by looking at the extension and determine which sub folder it should be placed into. This was a project I came up with myself and created the code from scratch. I have linked my GitHub account if you want to download this project and use it on your own devices.",
 ...
 
  {
    ...
    "title": "Android Game",
    "description": "This project is a game intended for Android Mobile devices, it was created within Android Studio using the Java programming language. The basic idea for this game was to create an IT industry oriented version of the class board game Risk. This would consist of players being able to draw a hand of cards, these cards include well known public IT figures such as Steve Jobs and Bill Gates. The player must then use these cards to battle against the AI in order to take over all the IT businesses in each continent. If you are interested in seeing what I created you can download it from the link to my Github account I have provided below.",
